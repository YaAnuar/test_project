...
Revision ID: c39df59a8e98
Revises: cb34aa74dfb0
Create Date: 2022-07-17 08:01:14.516815
...
revision = 'c39df59a8e98'
down_revision = 'cb34aa74dfb0'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.UniqueConstraint('order_id', name='order_table_order_id_key')
    )
    op.drop_table('order')
    # ### end Alembic commands ###
